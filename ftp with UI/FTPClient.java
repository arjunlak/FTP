...
class FTPClient {
	...
	public SocketAddress remoteAddr;
     ...
     //   public fram()
	public FTPClient(String hostname,int p) throws Exception {
	...
	public void Menu(String x, String y) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		//String p = br.readLine();
               ...
               FTPClient ftp = new FTPClient(h,Integer.parseInt(p));
		ftp.Menu(use,pas);
	}
}